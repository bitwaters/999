...
- [ ] 11.4 实测 CoinGecko G2 quote、多 leg、重复、乱序、重连、每 socket/并发上限、rolling credits per message 和 50 池尾延迟。（真实合同验收 32/34；SOL 的 G2/G3 WebSocket 两项在 20 秒窗口内未收到数据，不能标记完成）
